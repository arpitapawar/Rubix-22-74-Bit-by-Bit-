...
<%@ page import="Hospital.DocLog" import="Hospital.Database" import="java.sql.ResultSet" %>
<!doctype html>
<html lang="en">
  <head>
    <!-- Required meta tags -->
...
body {
  ...
  <body>
    <%
String email=DocLog.email;
Database obj=new Database();
ResultSet rs=obj.checkDoc(email);
String name=null;
String path=null;
...
ResultSet rs1=obj.checkAppointForDoc(pat_name);	
...
%>
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent" >
              <ul class="navbar-nav mr-auto" >
                <li class="nav-item active">
                  <a class="nav-link" href="doc1_home.html" style="padding-right: 15px; color:white; font-size:20px;">Home </a>
                </li>
                <li class="nav-item">
    ...
    <div class="container">
        <div class="row">
          ...
          <div class="two" style="width: 670px; margin-left: 50px;">
                <p>
                ...
                <div class="collapse" id="collapseExample">
                   ...
                   <%out.println(rs.getString("experience")); %>
                    </div>
                </div>
                <p>
                    <a class="btn " style="background-color: #ce3288; color: white; margin-top: 30px;" data-toggle="collapse" href="#collapseExample1" role="button" aria-expanded="false" aria-controls="collapseExample">
                    Specialization
                    </a>
                </p>
                ...
                <div class="collapse" id="collapseExample4">
                    <div class="card card-body">
                      <table border='1'><tr><td>Name</td><td>Contact</td><td>Gender</td><td>Medical History</td><td>Health Issue</td><td>Appointment Date</td><td>Slot</td><td>Meeting Link</td></tr>
                <% 
                while(rs1.next()) {
